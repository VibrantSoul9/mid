...
* If user input is not a letter (between a and z or A and Z) or is a string of length >1,
* print an error message
* for eg. Input an alphbet : p
* Expected Output :
...
public class Programme_3_FindVowelOrConsonant {
    public static void checkVowelOrConsonant(String letter) {
        ...
        // if user enters more than 1 chracter an error message is pri
        if (letter.length() > 1) {
